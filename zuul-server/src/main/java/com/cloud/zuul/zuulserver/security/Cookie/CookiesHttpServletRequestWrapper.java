...
public class CookiesHttpServletRequestWrapper extends HttpServletRequestWrapper {
    ...
    private Boolean ifOtherLoginOut;
    ...
    public Boolean getIfOtherLoginOut() {
        return ifOtherLoginOut;
    }

    public void setIfOtherLoginOut(Boolean ifOtherLoginOut) {
        this.ifOtherLoginOut = ifOtherLoginOut;
    }
}
