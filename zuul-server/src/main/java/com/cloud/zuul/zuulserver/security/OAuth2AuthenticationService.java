...
import com.cloud.zuul.zuulserver.security.Cookie.OAuth2Cookies;
...
public class OAuth2AuthenticationService {
     ...
     * 缓存 refreshToken -> OAuth2Cookies,避免多线程多次刷新，同时设定过期时间。
     */
    ...
    public ResponseEntity<OAuth2AccessToken> authenticate(HttpServletRequest request, HttpServletResponse response,
                                                          Map<String, String> params) throws BusiException {
    ...
    public HttpServletRequest refreshToken(HttpServletRequest request, HttpServletResponse response, Cookie
        refreshCookie)  throws Exception{
    ...
    public void logout(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws Exception{
        ...
        authorizationClient.loginOut(token);
