package com.cloud.resource.re1server.dao.inft;
...
public interface ILoadTimeDao {
     ...
     * @return
     */
    Integer insertLoadTime(LoadTime loadTime);

    /**
     * 批量新增对象
     * @param list
     */
    void insertLoadTimeList(List<LoadTime> list);
     ...
     * @return
     */
    Integer deleteLoadTimeByKey(Long ltId);

    /**
     * 批量删除对象
     * @param list
     */
    void deleteLoadTimeList(List<LoadTime> list);
