package com.cloud.resource.re1server.service.inft;
...
public interface ILoadTimeService {
     ...
     * @throws Exception
     */
    Integer insertLoadTime(LoadTime loadTime) throws Exception;
     ...
     * @throws Exception
     */
    void insertLoadTimeList(List<LoadTime> loadTimeList) throws Exception;
     ...
     * @throws Exception
     */
    Integer deleteLoadTimeByKey(Long ltId) throws Exception;
     ...
     * @throws Exception
     */
    void deleteLoadTimeList(List<LoadTime> loadTimeList) throws Exception;
     ...
     * @throws Exception
     */
     void saveLoadTime(LoadTime loadTime,Boolean isFullUpdate) throws Exception;
     ...
     * @throws Exception
     */
     void saveLoadTimeList(List<LoadTime> loadTimeList,Boolean isFullUpdate) throws Exception;
}
