 ...
 * @author lijun
 */
public class SysRolePermission extends PageEntity implements Serializable {
	/**
	* field comment: 主键 
	*/
	private Long srpId;
	...
	*/
	...
	public static final transient String PROP_SRP_ID = "srpId";
	public static final transient String TABLE_SRP_ID = "srp_id";
	...
	public Long getSrpId() { return srpId; }

	public void setSrpId(Long srpId) { this.srpId = srpId; }
