...
public interface ISysCompanyDao {
     ...
     * @return
     */
    Integer insertSysCompany(SysCompany sysCompany);

    /**
     * 批量新增对象
     * @param list
     */
    void insertSysCompanyList(List<SysCompany> list);
     ...
     * @return
     */
    Integer deleteSysCompanyByKey(Long scId);

    /**
     * 批量删除对象
     * @param list
     */
    void deleteSysCompanyList(List<SysCompany> list);
